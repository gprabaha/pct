function anayze_strategy_interactions_3_patch()

files = dir('../+data/3-patches*');
...
suptitle('3-patch: Cumulative rewards for strategy-pairs');

fname = '3-patch-cumulative-reward';
exp_to_pdf(fname);
close;
