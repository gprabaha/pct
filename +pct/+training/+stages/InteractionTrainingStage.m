classdef InteractionTrainingStage < pct.util.TrainingStage
  properties
    Name;
    FixDur;
    FixHoldDur;
    ...
    M2SaccadeTime = 0;
    TrialsPerBlock = 20;
    BlockNames = {'Competition', 'Cooperation'};
  ...
  methods
    function obj = InteractionTrainingStage(fix_dur, fix_hold_dur, patch_dur)
